...
class Data_Layer_train(caffe.Layer):
    def setup(self, bottom, top):
        self.batch_size = 64
	net_side = 24
	cls_list_txt = '../prepare_data/imglists/RNet/cls_RNet.txt'
	roi_list_txt = '../prepare_data/imglists/RNet/roi_RNet.txt'
	pts_list_txt = '../prepare_data/imglists/RNet/pts_RNet.txt'
...
class BatchLoader(object):
    def __init__(self,cls_list_txt,roi_list_txt,pts_list_txt,net_side,cls_root,roi_root,pts_root):
    	...
    	if imdb_exit:
    		fid = open('../prepare_data/imglists/RNet/cls.imdb','r')
        ...
        if imdb_exit:
        	fid = open('../prepare_data/imglists/RNet/roi.imdb','r')
        ...
        if imdb_exit:
        	fid = open('../prepare_data/imglists/RNet/pts.imdb','r')
