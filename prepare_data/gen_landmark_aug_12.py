...
def IoU(box, boxes):
    ...
    return ovr
def GenerateData(ftxt, imgdir, output,net,argument=False):
    if net == "PNet":
        size = 12
    elif net == "RNet":
        size = 24
...
if __name__ == '__main__':
    ...
    net = "PNet"
    #train_txt = "train.txt"
    train_txt = "trainImageListNew2.txt"
    imgdir = "./train/"
    imgs,landmarks = GenerateData(train_txt, imgdir,  OUTPUT,net,argument=True)
