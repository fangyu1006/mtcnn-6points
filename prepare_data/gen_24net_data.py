...
pos_save_dir = "24new/positive"
part_save_dir = "24new/part"
neg_save_dir = '24new/negative'
save_dir = "./24new"
...
for annotation in annotations:
    ...
    while neg_num < 50:
        ...
        if np.max(Iou) < 0.3:
            ...
            f2.write("24new/negative/%s.jpg"%n_idx + ' 0\n')
    ...
    for box in boxes:
        ...
        for i in range(20):
            ...
            if IoU(crop_box, box_) >= 0.65:
                ...
                f1.write("24new/positive/%s.jpg"%p_idx + ' 1 %.2f %.2f %.2f %.2f\n'%(offset_x1, offset_y1, offset_x2, offset_y2))
                cv2.imwrite(save_file, resized_im)
                p_idx += 1
            elif IoU(crop_box, box_) >= 0.4:
                save_file = os.path.join(part_save_dir, "%s.jpg"%d_idx)
                f3.write("24new/part/%s.jpg"%d_idx + ' -1 %.2f %.2f %.2f %.2f\n'%(offset_x1, offset_y1, offset_x2, offset_y2))
                cv2.imwrite(save_file, resized_im)
                d_idx += 1
        box_idx += 1
